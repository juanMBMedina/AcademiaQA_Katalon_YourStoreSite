...
docker run -t --rm -v "/%currentdir%:/tmp/source" -w /tmp/source katalonstudio/katalon katalon-execute.sh -browserType="Firefox" -testSuitePath="Test Suites/your_site/login_user_test_suite" -propertiesFile="/tmp/source/console.properties"
