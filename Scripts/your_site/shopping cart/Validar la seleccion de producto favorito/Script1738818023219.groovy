...
WebUI.click(findTestObject('your_site/landing_page/item/wish_item_selected', [('title') : title_element]))

WebUI.verifyElementVisible(findTestObject('your_site/landing_page/item/mssg_wish_item_selected', [('title') : title_element]))

WebUI.click(findTestObject('your_site/landing_page/my_account_wish_list'))

WebUI.verifyElementPresent(findTestObject('your_site/wish_items/title_item', [('title') : data_element.getAt('name')]), 0)
