...
WebUI.click(findTestObject('your_site/account_page/logout_link'))

WebUI.verifyTextPresent('You have been logged off your account. It is now safe to leave the computer.', false)

WebUI.verifyTextPresent('Your shopping cart has been saved, the items inside it will be restored whenever you log back into your account.', 
    false)
